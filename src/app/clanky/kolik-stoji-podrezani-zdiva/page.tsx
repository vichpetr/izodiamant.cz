...
const DESC = "Ceny podřezání a sanace zdiva: řetězová pila a chemická injektáž od 2 500 Kč/bm, diamantové lano od 4 500 Kč/bm (za běžný metr při tloušťce 45 cm). Nejsme plátci DPH.";
...
const SERVICES = [
  { href: "/sluzby/retezova-pila", label: "Řetězová pila", note: "od 2 500 Kč/bm – cihelné zdivo." },
  { href: "/sluzby/diamantove-lano", label: "Diamantové lano", note: "od 4 500 Kč/bm – kámen a beton." },
  { href: "/sluzby/chemicka-injektaz", label: "Chemická injektáž", note: "od 2 500 Kč/bm – kde nelze řezat." },
];
...
export default function Page() {
  return (
    <ArticleLayout
      ...
      intro={<>Cena podřezání se počítá za <strong className="text-neutral-dark">běžný metr (bm) délky zdi</strong>, ne za m² plochy. Níže najdete orientační sazby a co všechno konečnou cenu ovlivňuje.</>}
    >
      <H2>Orientační ceny</H2>
      <P>Sazby platí za běžný metr při referenční tloušťce zdiva 45 cm; u silnějšího zdiva cena úměrně roste. <strong className="text-neutral-dark">Nejsme plátci DPH</strong>, uvedené částky se tedy o daň dále nenavyšují.</P>
      ...
      <H2>Proč za běžný metr, a ne za m²</H2>
      <P>U vodorovné izolace se řeže spára po délce stěny – rozhoduje tedy, kolik běžných metrů se podřezává a jak je zdivo silné, ne plocha stěny. Cenu za m² proto neuvádíme; byla by zavádějící.</P>
      ...
      <ul className="space-y-2 text-neutral-dark/80">
        {[
          ...
          "Tloušťka zdiva – u silnějších stěn roste množství řezu",
          "Délka podřezávané zdi (počet běžných metrů)",
      ...
      <P>Nezávazný odhad si spočítáte během chvíle v naší online kalkulačce – zadáte materiál, tloušťku a délku zdi. Závaznou nabídku pak zpracujeme po prohlídce objektu, kde cenu potvrdíme, aby se ve výsledné faktuře neměnila.</P>
      <div className="pt-1">
