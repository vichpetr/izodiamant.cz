...
export const metadata: Metadata = {
  ...pageMetadata({
    ...
    description: "Podřezání zdiva řetězovou pilou – nejrychlejší metoda pro cihelné zdivo, vložení hydroizolace s životností přes 50 let. Orientační cena od 2 500 Kč/m².",
...
export default function ChainSawPage() {
  ...
  const breadcrumb = breadcrumbSchema([
    ...
    { name: "Řetězová pila", path: "/sluzby/retezova-pila" },
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-neutral-dark/5">
              ...
              <p className="text-neutral-dark/70 font-medium">Používáme certifikované PE fólie s životností přes 50 let.</p>
            </div>
          </div>
      ...
      <section className="py-24 bg-neutral-light overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="text-neutral-dark/70 font-medium">Prohlédněte si naše projekty, kde jsme využili řetězovou pilu.</p>
          </div>
      ...
      <section className="py-20 bg-white border-t border-neutral-dark/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/sluzby/diamantove-lano" className="group flex items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-neutral-dark/5 shadow-sm hover:shadow-xl hover:border-primary/30 transition-all">
              <span className="font-black uppercase italic text-neutral-dark group-hover:text-primary transition-colors">Podřezávání diamantovým lanem</span>
