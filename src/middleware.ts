...
export function middleware(request: NextRequest) {
  ...
  if (acceptHeader.includes('text/markdown')) {
    ...
    response.headers.set('Link', '</llms.txt>; rel="service-doc", </.well-known/api-catalog.json>; rel="api-catalog", </.well-known/openid-configuration.json>; rel="openid-configuration", </.well-known/oauth-protected-resource.json>; rel="oauth-protected-resource", </.well-known/agent-card.json>; rel="agent-card"');
