...
## Hlavní Služby
- **Podřezávání diamantovým lanem**: Ideální pro kamenné, betonové a silné smíšené zdivo. Šetrná metoda s minimem otřesů. Rozhodujícím kritériem je materiál zdiva, nikoli jeho tloušťka – lano zvládne tvrdý kámen i u tenkých stěn a zároveň nemá limit tloušťky (i přes dva metry). Orientační cena od 4 500 Kč/bm, realizace 3–5 pracovních dnů. https://izodiamant.cz/sluzby/diamantove-lano
- **Podřezávání řetězovou pilou**: Nejrychlejší metoda pro cihelné zdivo s průběžnou ložnou spárou. Vkládání hydroizolační PE fólie o tloušťce 2 mm s životností přesahující 50 let. Orientační cena od 2 500 Kč/bm, realizace 2–3 pracovní dny. https://izodiamant.cz/sluzby/retezova-pila
- **Chemická injektáž**: Vytvoření hydroizolační clony pomocí certifikovaných gelů nebo krémů na bázi silanů a siloxanů v místech, kde nelze řezat. Orientační cena od 2 500 Kč/bm, realizace 1–2 pracovní dny. https://izodiamant.cz/sluzby/chemicka-injektaz
...
- **Doporuč a získej odměnu:** Za tip na nového zákazníka náleží finanční odměna, pokud tip obdržíme dříve, než nás klient sám kontaktuje. Vyplácí se po dokončení a proplacení zakázky. https://izodiamant.cz/doporuc-a-ziskej-odmenu
