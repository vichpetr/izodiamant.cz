          ...
          <div className="space-y-12">
            ...
            <div className="p-8 bg-neutral-light rounded-3xl border-2 border-neutral-dark/5">
              ...
              <p className="text-neutral-dark/60 text-sm font-medium leading-relaxed">
                Náš odborný technik vás navštíví, provede přesné měření a navrhne nejvhodnější technologický postup přímo na míru vaší stavbě. Vše zcela zdarma a nezávazně.
              </p>
            </div>
          </div>
