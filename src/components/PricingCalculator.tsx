                  ...
                  <div className="space-y-8">
                    <div className="grid lg:grid-cols-4 gap-6">
                      ...
                      <div className="lg:col-span-1 space-y-3">
                        <h3 className="text-[9px] font-black text-primary uppercase tracking-[0.2em] mb-2 italic">1. Typ zdiva</h3>
                      ...
                      {/* Col 2: Technology (25%) */}
                      <div className="lg:col-span-1 space-y-3 border-l lg:border-white/5 lg:pl-6">
                        <h3 className="text-[9px] font-black text-primary uppercase tracking-[0.2em] mb-2 italic">2. Technologie</h3>
                        <div className="flex flex-col gap-2">
                          {!materialId ? (
                      ...
                      {/* Col 3: Price Box (50%) */}
                      <div className="lg:col-span-2 flex flex-col justify-center border-l lg:border-white/5 lg:pl-6">
                        <div className="bg-primary/10 rounded-2xl p-6 border-2 border-primary/20 text-center relative overflow-hidden">
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 pt-6 border-t border-white/5">
                      <div>
                        <div className="flex justify-between items-end mb-3">
                          <h3 className="text-[10px] font-black text-primary uppercase tracking-[0.2em] italic">3. Tloušťka zdiva</h3>
                      ...
                      <div>
                        <div className="flex justify-between items-end mb-3">
                          <h3 className="text-[10px] font-black text-primary uppercase tracking-[0.2em] italic">4. Délka zdi</h3>
